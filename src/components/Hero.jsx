  ...
  return (
    <div className="relative flex items-center justify-center bg-gradient-to-l from-blue-400 via-purple-500 to-red-300 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" className="h-[180px] sm:h-[180px]" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 60C240 120 480 0 720 60C960 120 1200 0 1440 60V120H0V60Z" fill="white" fillOpacity="0.3"/>
        </svg>
      </div>
      <div className="relative z-10 flex flex-col md:flex-row items-center max-w-6xl px-4 sm:px-6 lg:px-8 py-2">
        <div>
          ...
          <button className="flex items-center gap-2 m-2 border-2 border-black shadow-md hover:shadow-xl hover:scale-102 rounded-lg transition-all duration-300 active:scale-105 group w-50">
            ...
            <p className="flex-1 bg-red-800 group-hover:bg-blue-900 transition-colors duration-300 text-white px-4 py-1 rounded-r-md">
                Create New Room
            </p>
          </button>
          <button className="flex items-center gap-2 m-2 border-2 border-black shadow-md hover:shadow-xl hover:scale-102 rounded-lg transition-all duration-300 active:scale-105 group w-50">
            <img className="w-6 ml-1 h-6" src={join_room} alt="" />
            <p className="flex-1 bg-blue-900 group-hover:bg-red-800 transition-colors duration-300 text-white px-4 py-1 rounded-r-md">
                Join Room
            </p>
          </button>
        </div>
        <div className="flex flex-row flex-wrap gap-2 justify-center md:flex-shrink-0 mt-5">
